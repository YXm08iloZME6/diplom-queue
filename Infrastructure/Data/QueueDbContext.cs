...
<<<<<<< HEAD
        ...
        service.HasData(
            new {Id = Guid.Parse("dfc3d5c0-69fc-4ac1-a593-473b945dd3bc"), Name = "Регистратура", Description = "Запись на первичный прием, заведение медицинских карт и предоставление справочной информации о работе клиники.", IconName="Book", Letter = "A", IsActive = true, IsNeedFacets = true, ParentId = (Guid?)null },
            new {Id = Guid.Parse("99c48a22-122d-4821-afea-2b2b345e592c"), Name = "Платные услуги", Description = "Оформление и оплата медицинских услуг, не входящих в программу ОМС.", IconName="Ruble", Letter = "B", IsActive = true, IsNeedFacets = true, ParentId = (Guid?)null },
            new {Id = Guid.Parse("7370aa38-cbb9-4220-915d-ce042194f24e"), Name = "Анализы", Description = "Лабораторная диагностика от общих анализов крови до генетических исследований.", IconName="Lab", Letter = "C", IsActive = true, IsNeedFacets = true, ParentId = (Guid?)null },
            new {Id = Guid.Parse("9d78a673-efa3-4af3-9828-55515d26e134"), Name = "Запись на прием к врачу", Description = "Выбор специалиста и бронирование подходящего времени визита.", IconName="Clock", IsActive = true, IsNeedFacets = true, ParentId = Guid.Parse("dfc3d5c0-69fc-4ac1-a593-473b945dd3bc") },
            new {Id = Guid.Parse("d320728d-0a5e-490c-be3c-04bcf3a7a4c8"), Name = "Оформление больничного", Description = "Официальное подтверждение временной нетрудоспособности.", IconName="CheckBook", IsActive = true, IsNeedFacets = true, ParentId = Guid.Parse("dfc3d5c0-69fc-4ac1-a593-473b945dd3bc") }
=======
        ...
        service.HasData(
            ...
            new {Id = Guid.Parse("ef30bd6a-f192-4b25-8885-f7d679c6b313"), Name = "Просто спросить", Description = "Мне просто спросить", IconName="Lab", Letter = "D", ParentId = (Guid?)null, NeedMoreInfo = true },
